...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-r/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-r/actions/workflows/validate.yml)

Neovim tree-sitter queries for **r**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-r",
...
- [ ] Changes are scoped to `r` — do not include files for other languages
